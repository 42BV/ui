...
export default {
  title: 'Form/CheckboxMultipleSelect',
  ...
  parameters: {
    component: CheckboxMultipleSelect
  }
};
  ...
  return (
    <Card className="m-2">
      ...
      <p className="mt-3">
        ...
        should use the ModalPickerMultiple.
      </p>
    </Card>
  );
};
...
const OptionsShouldAlwaysContainValueStory = () => {
  const permissions = [
    'CREATE_CAR',
    'UPDATE_CAR',
    'READ_CAR',
  ...
  return (
    <Card className="m-2">
      ...
      <p>
        ...
        not the form element should always contain the value which is selected.
      </p>

      <p>
        It should be <strong>true</strong> when using it in the following
        situation: The form element receives a value which is no longer part of
        the options. In that case it is handy to have the value automatically
        added to the options, so the user still sees the select value.
      </p>
      ...
      <p>
        ...
        <ol>
          ...
          <li>
            ...
            example you have an array of permissions of what the user can do in
            the system, visually you display grouped by parts of the domain.
            This means giving the same `value` to various form element
      ...
      <p>
        In the above example it is <strong>false</strong> because otherwise the
        selected CREATE options would appear in each form element, and not just
...
export const OptionsShouldAlwaysContainValue = {
  render: OptionsShouldAlwaysContainValueStory,
  name: 'optionsShouldAlwaysContainValue'
};
