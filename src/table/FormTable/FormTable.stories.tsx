...
export const EditPerRow = {
  render: EditPerRowStory,
  name: 'edit per row'
};

const InstantEditStory = () => {
  const [newPerson] = useState<Person>({
    id: Math.random(),
    firstName: '',
    lastName: '',
...
export const InstantEdit = {
  render: InstantEditStory,
  name: 'instant edit'
};

const CopyPasteToSpreadsheetStory = () => {
  const [newPerson] = useState<Person>({
    id: Math.random(),
    firstName: '',
    lastName: '',
  ...
  return (
    <Card body>
      ...
      <p>
        You can also use the copy and paste keyboard shortcuts when no input is
        focussed.
      </p>
...
export const CopyPasteToSpreadsheet = {
  render: CopyPasteToSpreadsheetStory,
  name: 'copy / paste to spreadsheet'
};
